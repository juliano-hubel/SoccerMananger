...
namespace SoccerManager.Infra.Migrations
{
    ...
    [Migration("20190222143406_AddStudentsClassrooms")]
    partial class AddStudentsClassrooms
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoccerManager.Domain.Entities.Classroom", b =>
                {
                    ...
                    b.Property<Guid?>("StudentsClassroomsId");

                    b.HasKey("Id");

                    b.HasIndex("StudentId");

                    b.HasIndex("StudentsClassroomsId");
            ...
            modelBuilder.Entity("SoccerManager.Domain.Entities.Classroom", b =>
                {
                    b.HasOne("SoccerManager.Domain.Entities.Student")
                        .WithMany("Classrooms")
                        .HasForeignKey("StudentId");

                    b.HasOne("SoccerManager.Domain.Entities.StudentsClassrooms")
                        .WithMany("Classrooms")
                        .HasForeignKey("StudentsClassroomsId");
                });
